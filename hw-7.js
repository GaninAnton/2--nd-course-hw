...
// let line = String(prompt( `введи текст...`));
...
//     let arrNew = [];
//     for (let int of arr) {
//         if (int.toLowerCase().startsWith(str.toLowerCase())) {
//             arrNew.push(int);
//    } 
//     }
//     console.log(arrNew);
...
// numberMax = Math.max(52, 53, 49, 77, 21, 32);
// numberMin = Math.min(52, 53, 49, 77, 21, 32);
...
//     numberResult= Math.round(Math.random() * (10 - 1) + 1);
...
// возвращать массив случайных целых чисел от 0 до переданного числа. Длина массива должна быть в 2 раза меньше переданного числа.
...
//             RandomNamber.push(Math.round(Math.random() * 10))
//         }
...
// function RandomNamber(maxNum, minNum) {
//     let result = Math.round(Math.random() * (maxNum - minNum) + minNum);
